...
function Header({ toggleSidebar }) {
    ...
    return (
        <div className='bg-white h-16 px-4 flex justify-between items-center relative'>
            <div className='flex items-center'>
                <HiOutlineMenu className="text-3xl cursor-pointer" onClick={toggleSidebar} />
            </div>
            <div ref={dropdownRef} className='bg-white h-16 px-4 flex justify-between items-center relative'>
                <button 
                    className="flex items-center text-sm font-medium text-gray-900 rounded-full md:me-0 focus:outline-none" 
                    type="button"
